        ...
        <Box sx={{ flex: 1,p: { xs: 2, md: 3 }, display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center" }}>
                <Box sx={{ flex: 2, display: "flex", gap: 2 }}>
                     <Link to="/booking"
                    className="w-full py-2 bg-[#468F9D] flex justify-center items-center rounded text-white  font-medium md:text-[18px] md:font-semibold"
                       
                    >
                        View Details
                    </Link>
                    <button className="w-full cursor-pointer py-2 bg-[#8AC197] flex justify-center items-center rounded text-white  font-medium md:text-[18px] md:font-semibold">
                        Remove
                    </button>
