...
import { Search, Plus, MoreHorizontal, Paperclip, Send, ArrowLeft } from "lucide-react"
...
const Inbox = () => {
    ...
    // const [selectedChat, setSelectedChat] = useState(conversations[0]?.id || null)
        ...
        <div className="container mx-auto md:my-20  md:px-10">
            ...
            <div className={`${!showChatList ? "flex" : "hidden"} md:flex flex-1 flex-col`}>
                {selectedConversation ? (
                    <>
                        {/* Chat Header */}
                        <div className="p-4 md:border-b border-gray-200 flex items-center justify-between">
                        ...
                        {/* Message Input */}
                        <div className="p-4  md:border-t border-gray-200">
                            <div className="flex items-center gap-3">
                                {/* <button className="p-2 hover:bg-gray-100 rounded-lg transition-colors">
                                ...
                                <div className="flex-1 relative mt-10 md:mt-0">
                                    <input
                                        ...
                                        className="text-sm w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                    />
                                </div>
                                <button
                                    onClick={handleSendMessage}
                                    className="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 mt-10 md:mt-0"
                                >
