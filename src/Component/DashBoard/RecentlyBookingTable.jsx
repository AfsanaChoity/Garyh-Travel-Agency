  ...
  return (
    <div className=" mt-10 ">
      ...
      <div className="flex  items-center justify-between mb-6">
        <h2 className="md:text-xl  font-semibold text-gray-900">Recently Booking</h2>
        <button
...
export default RecentlyBookingTable
